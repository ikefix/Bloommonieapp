...
//         // =============================================
//         // STEP 1: REVERSE the old entry's stock effect
//         // =============================================
...
//                 // Reverse: deduct back what was added
//                 if ($request->entry_type === 'output') {
...
//         // =============================================
//         // STEP 2: APPLY new entry's stock effect
//         // =============================================
//         foreach ($request->items as $item) {
...
//         // =============================================
//         // STEP 3: SAVE updated entry
//         // =============================================
//         ProductionEntry::where('production_id', $productionId)
//             ->where('entry_type', $request->entry_type)
//             ->update([
//                 'meta' => ['items' => $request->items]
//             ]);
